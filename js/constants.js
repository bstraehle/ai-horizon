...
const COLORS = deepFreeze({
  ...
  NEBULA: {
    N1: "rgba(220, 20, 60, 0.18)",
    N1_OUT: "rgba(220, 20, 60, 0)",
    N2: "rgba(180, 0, 0, 0.16)",
    N2_OUT: "rgba(180, 0, 0, 0)",
    N3: "rgba(255, 80, 0, 0.14)",
    N3_OUT: "rgba(255, 80, 0, 0)",
    N4: "rgba(90, 0, 0, 0.20)",
    N4_OUT: "rgba(90, 0, 0, 0)",
  },
  NEBULA_BLUE: {
    B1: "rgba(0, 170, 220, 0.16)",
    B1_OUT: "rgba(0, 170, 220, 0)",
    B2: "rgba(0, 110, 180, 0.14)",
    B2_OUT: "rgba(0, 110, 180, 0)",
    B3: "rgba(0, 240, 200, 0.12)",
    B3_OUT: "rgba(0, 240, 200, 0)",
    B4: "rgba(0, 60, 120, 0.18)",
    B4_OUT: "rgba(0, 60, 120, 0)",
  },
  PLAYER: {
    COCKPIT: "#b20000",
    GRAD_BOTTOM: "#fff",
...
export const CONFIG = deepFreeze({
  ...
  GAME: {
    ...
    GOLDEN_ASTEROID_COUNT: 5,
    GOLDEN_INTERVAL_SECONDS: 10,
    TIMER_SECONDS: 60,
    FINALE_BONUS_WINDOW_SECONDS: 10,
