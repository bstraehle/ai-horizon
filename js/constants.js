...
const COLORS = deepFreeze({
  ...
  NEBULA_BLUE: {
    B1: "rgba(12, 12, 122, 0.11)",
    B1_OUT: "rgba(12, 12, 122, 0)",
    B2: "rgba(10, 10, 105, 0.10)",
    B2_OUT: "rgba(10, 10, 105, 0)",
    B3: "rgba(20, 28, 140, 0.095)",
    B3_OUT: "rgba(20, 28, 140, 0)",
    B4: "rgba(8, 8, 90, 0.12)",
    B4_OUT: "rgba(8, 8, 90, 0)",
  },
  PLAYER: {
    COCKPIT: "#b20000",
    GRAD_BOTTOM: "#fff",
